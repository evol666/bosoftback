package net.athanor.app.repository;

import static net.athanor.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import net.athanor.app.config.audit.AuditEventConverter;
import net.athanor.app.domain.PersistentAuditEvent;
