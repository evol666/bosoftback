package net.athanor.app.web.rest;

import static net.athanor.app.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.athanor.app.BosoftBackApp;
import net.athanor.app.config.Constants;
import net.athanor.app.domain.User;
import net.athanor.app.repository.AuthorityRepository;
import net.athanor.app.repository.UserRepository;
import net.athanor.app.security.AuthoritiesConstants;
import net.athanor.app.service.UserService;
import net.athanor.app.service.dto.PasswordChangeDTO;
import net.athanor.app.service.dto.UserDTO;
import net.athanor.app.web.rest.vm.KeyAndPasswordVM;
import net.athanor.app.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = BosoftBackApp.class)
